...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 48075)), "C:\\wamp64\\www\\plenty\\plenti-web\\app\\(dashboard)\\(route)\\customer\\category\\otherservices\\page.tsx"],
    ...
    const pages = ["C:\\wamp64\\www\\plenty\\plenti-web\\app\\(dashboard)\\(route)\\customer\\category\\otherservices\\page.tsx"];

    

    const originalPathname = "/(dashboard)/(route)/customer/category/otherservices/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/(dashboard)/(route)/customer/category/otherservices/page","pathname":"/customer/category/otherservices","bundlePath":"app/(dashboard)/(route)/customer/category/otherservices/page","filename":"","appPaths":[]}}
...
var __webpack_exports__ = __webpack_require__.X(0, [2697,9792,1440,229,5386,6172,4521,2273,9132,1393,2972,6070], () => (__webpack_exec__(37765)));
