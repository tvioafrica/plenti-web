...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 19909)), "C:\\wamp64\\www\\plenty\\plenti-web\\app\\(dashboard)\\(route)\\merchant\\promotions\\create\\page.tsx"],
    ...
    const pages = ["C:\\wamp64\\www\\plenty\\plenti-web\\app\\(dashboard)\\(route)\\merchant\\promotions\\create\\page.tsx"];

    

    const originalPathname = "/(dashboard)/(route)/merchant/promotions/create/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/(dashboard)/(route)/merchant/promotions/create/page","pathname":"/merchant/promotions/create","bundlePath":"app/(dashboard)/(route)/merchant/promotions/create/page","filename":"","appPaths":[]}}
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 66009))
...
var dist = __webpack_require__(43618);
...
;// CONCATENATED MODULE: ./app/(dashboard)/(route)/merchant/promotions/create/page.tsx
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("form", {
                ...
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        ...
                        children: formField.map((item, index)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        className: "w-2/3 flex float-right",
...
/* harmony default export */ const page = (CreatePromotion);
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\wamp64\www\plenty\plenti-web\app\(dashboard)\(route)\merchant\promotions\create\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [2697,9792,1440,3380,4178,8966,3157,9132,5904], () => (__webpack_exec__(70332)));
