...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 56206)), "C:\\wamp64\\www\\plenty\\plenti-web\\app\\(landingpage)\\(login)\\register\\page.tsx"],
    ...
    const pages = ["C:\\wamp64\\www\\plenty\\plenti-web\\app\\(landingpage)\\(login)\\register\\page.tsx"];

    

    const originalPathname = "/(landingpage)/(login)/register/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/(landingpage)/(login)/register/page","pathname":"/register","bundlePath":"app/(landingpage)/(login)/register/page","filename":"","appPaths":[]}}
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h2", {
                ...
                children: "Create your Plenti Account"
            }),
...
var __webpack_exports__ = __webpack_require__.X(0, [2697,9792,1440,3380,4178,4407,2451,1539,9132,4980,2984], () => (__webpack_exec__(19474)));
