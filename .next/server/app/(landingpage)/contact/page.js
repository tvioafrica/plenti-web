...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 46011)), "C:\\wamp64\\www\\plenty\\plenti-web\\app\\(landingpage)\\contact\\page.tsx"],
    ...
    const pages = ["C:\\wamp64\\www\\plenty\\plenti-web\\app\\(landingpage)\\contact\\page.tsx"];

    

    const originalPathname = "/(landingpage)/contact/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/(landingpage)/contact/page","pathname":"/contact","bundlePath":"app/(landingpage)/contact/page","filename":"","appPaths":[]}}
...
;// CONCATENATED MODULE: ./app/(landingpage)/contact/HeroSection.tsx
...
const HeroSection = ()=>{
    return /*#__PURE__*/ jsx_runtime_.jsx("section", {
        ...
        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
            className: "container mx-auto flex px-2 md:px-2 flex-col md:flex-row items-center py-14 md:space-x-20",
            children: [
                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                    ...
                    children: [
                        /*#__PURE__*/ jsx_runtime_.jsx("h2", {
                            ...
                            children: _constants/* faqSection */.Bx.text
                        }),
                        /*#__PURE__*/ jsx_runtime_.jsx("p", {
                            className: "py-10 md:text-2xl text-lg",
                            children: _constants/* faqSection */.Bx.subtext
                        })
                    ]
                }),
                /*#__PURE__*/ jsx_runtime_.jsx("div", {
                    ...
                    children: /*#__PURE__*/ jsx_runtime_.jsx((image_default()), {
                        src: _constants/* faqSection */.Bx.Image,
                        width: 400,
                        height: 400,
                        alt: "logo",
                        className: "md:py-10"
...
/* harmony default export */ const contact_HeroSection = (HeroSection);
...
;// CONCATENATED MODULE: ./app/(landingpage)/contact/page.tsx
...
const Page = ()=>{
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: "",
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(contact_HeroSection, {}),
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                className: "container mx-auto flex my-20 px-4 md:px-o",
                children: [
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ jsx_runtime_.jsx("h3", {
                                ...
                                children: "Account and Registration"
                            }),
                            /*#__PURE__*/ jsx_runtime_.jsx("ul", {
                                className: "flex flex-col ",
                                children: _constants/* FaqLinks */.oP.map((link)=>/*#__PURE__*/ jsx_runtime_.jsx((link_default()), {
                                        href: link.href,
                                        className: "text-base",
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                className: "container mx-auto flex md:w-1/3 flex-col px-2 md:px-0 text-center",
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx("h3", {
                        className: "text-bold text-3xl",
                        children: _constants/* contact */.PX.title
                    }),
                    /*#__PURE__*/ jsx_runtime_.jsx("p", {
                        className: "text-lg py-6",
                        children: _constants/* contact */.PX.subtext
                    })
                ]
            }),
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                ...
                children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
                    className: "flex md:flex-row gap-4 lg:gap-0 lg:space-x-6 flex-col",
                    children: _constants/* contact */.PX.items.map((item, index)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                            className: "flex p-4 border rounded-md flex-col ",
                            children: [
...
module.exports = createProxy("C:\\wamp64\\www\\plenty\\plenti-web\\node_modules\\next\\dist\\client\\link.js");
...
var __webpack_exports__ = __webpack_require__.X(0, [2697,9792,1440,3380,4178,4407,2451,1539,4274,9132,4980,8545,4246], () => (__webpack_exec__(6193)));
